...
public class PoseNet2 : MonoBehaviour
{
    ...
    private string predictionLayer = "prediction_layer";
    ...
    void Start()
    {
        ...
        videoTexture = new RenderTexture(videoWidth, videoHeight, 24, RenderTextureFormat.RGB565);
    ...
    void Update()
    {
       ...
       // Dictionary<string, Tensor> inputs = new Dictionary<string, Tensor>() { { "input.1", null } };
        Tensor input = new Tensor(MainTexture, channels: 3);
    ...
    private void CameraSet()
    {
        ...
        MainTexture = RenderTexture.GetTemporary(imageWidth, imageHeight, 24, RenderTextureFormat.ARGBHalf);
